...
1. Abrir o app `bacen/` → aba Início: fazer o que está em "Prioridades de hoje" (revisões primeiro).
...
| Camada | Onde | Status |
|---|---|---|
| App PWA (registro + dashboard + SRS + motor) | `/bacen/` no GitHub Pages — instalável no celular | ✅ pronto |
